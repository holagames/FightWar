...
public class ActivityItemFixed
{
    public int ItemFixedID { get; private set; }
    ...
    public ActivityItemFixed(int _ItemFixeID, int _ActivityID, int _Round, int _Type, int _ConvertType, int _Param1, int _Param2, string _Des, int _ConvertCount, int _ItemID1, int _ItemNum1, int _ItemID2, int _ItemNum2, int _ItemID3, int _ItemNum3, int _ItemID4, int _ItemNum4)
    {
        this.ItemFixedID = _ItemFixeID;
