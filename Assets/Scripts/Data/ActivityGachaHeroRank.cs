...
public class ActivityGachaHeroRank 
{
    ...
    public ActivityGachaHeroRank(int _ID,int _ActivityID,int _Rank,int _BonusID1,int _BonusNum1,int _BonusID2,int _BonusNum2,int _BonusID3,int _BonusNum3,int _BonusID4,int _BonusNum4,
