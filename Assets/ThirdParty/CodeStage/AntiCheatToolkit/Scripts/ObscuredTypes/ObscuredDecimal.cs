...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	...
	/// <strong>\htmlonly<font color="FF4040">WARNING:</font>\endhtmlonly Flash Player is not supported! Consider using ObscuredFloat instead.</strong>
	public struct ObscuredDecimal : IEquatable<ObscuredDecimal>
	{
		/// <summary>
		/// Set it to any method you wish to be called in case of any ObscuredDecimal variable cheating detection.<br/>
		/// Fires only once.
		/// </summary>
