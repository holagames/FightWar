...
namespace CodeStage.AntiCheat.Detectors
{
	...
	public class InjectionDetector: MonoBehaviour
	{
		...
		private void Awake()
		{
			if (instance != null)
			{
				Debug.LogWarning("[ACT] Only one " + COMPONENT_NAME +" instance allowed!");
				Destroy(this);
				return;
			}
			...
			{
				Debug.LogWarning("[ACT] " + COMPONENT_NAME + " placed in scene incorrectly and will be auto-destroyed! Please, use \"GameObject->Create Other->Code Stage->Anti-Cheat Toolkit->" + COMPONENT_NAME + "\" menu to correct this!");
				Destroy(this);
				return;
			}
