...
Clicking on the filename will highlight that file in your Project window. Clicking on its file size will select it. All selected assets will have their total file sizes and percentages computed.
...
So you may find some prefab files in the "Used Assets" list that do not show a size reading. Those are the prefabs that were used in scenes but are not in a Resources folder, nor referenced as a variable.
...
Copyright © 2013 by Anomalous Underdog
