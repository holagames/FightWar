...
public class RigidbodyWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.Rigidbody", typeof(Rigidbody), regs, fields, typeof(UnityEngine.Component));
	}
	...
	static int SetDensity(IntPtr L)
	{
		...
		Rigidbody obj = LuaScriptMgr.GetUnityObject<Rigidbody>(L, 1);
