...
public class BoneWeightWrap
{
	...
	static int Equals(IntPtr L)
	{
		...
		BoneWeight obj = (BoneWeight)LuaScriptMgr.GetVarObject(L, 1);
	...
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		BoneWeight arg0 = (BoneWeight)LuaScriptMgr.GetVarObject(L, 1);
		BoneWeight arg1 = (BoneWeight)LuaScriptMgr.GetVarObject(L, 2);
		bool o = arg0 == arg1;
		LuaScriptMgr.Push(L, o);
		return 1;
	}
