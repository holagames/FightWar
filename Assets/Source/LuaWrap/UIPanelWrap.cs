...
public class UIPanelWrap
{
	...
	{
		LuaScriptMgr.Push(L, typeof(UIPanel));
		return 1;
	}
	...
	{
		UIPanel.list = LuaScriptMgr.GetNetObject<List<UIPanel>>(L, 3);
		return 0;
	}
	...
	static int set_onGeometryUpdated(IntPtr L)
	{
		...
		obj.onGeometryUpdated = LuaScriptMgr.GetNetObject<UIPanel.OnGeometryUpdated>(L, 3);
		return 0;
	}
	...
	static int set_renderQueue(IntPtr L)
	{
		...
		obj.renderQueue = LuaScriptMgr.GetNetObject<UIPanel.RenderQueue>(L, 3);
		return 0;
	}
	...
	static int set_widgets(IntPtr L)
	{
		...
		obj.widgets = LuaScriptMgr.GetNetObject<List<UIWidget>>(L, 3);
		return 0;
	}
	...
	static int set_drawCalls(IntPtr L)
	{
		...
		obj.drawCalls = LuaScriptMgr.GetNetObject<List<UIDrawCall>>(L, 3);
		return 0;
	}
	...
	static int set_worldToLocal(IntPtr L)
	{
		...
		obj.worldToLocal = LuaScriptMgr.GetNetObject<Matrix4x4>(L, 3);
		return 0;
	}
	...
	static int set_onClipMove(IntPtr L)
	{
		...
		obj.onClipMove = LuaScriptMgr.GetNetObject<UIPanel.OnClippingMoved>(L, 3);
		return 0;
	}
	...
	static int set_clipping(IntPtr L)
	{
		...
		obj.clipping = LuaScriptMgr.GetNetObject<UIDrawCall.Clipping>(L, 3);
		return 0;
	}
	...
	static int set_clipTexture(IntPtr L)
	{
		...
		obj.clipTexture = LuaScriptMgr.GetUnityObject<Texture2D>(L, 3);
		return 0;
	}
	...
	static int CompareFunc(IntPtr L)
	{
		...
		UIPanel arg0 = LuaScriptMgr.GetUnityObject<UIPanel>(L, 1);
		UIPanel arg1 = LuaScriptMgr.GetUnityObject<UIPanel>(L, 2);
	...
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		UIPanel obj = LuaScriptMgr.GetUnityObject<UIPanel>(L, 1);
	...
	static int IsVisible(IntPtr L)
	{
		...
		{
			UIPanel obj = LuaScriptMgr.GetUnityObject<UIPanel>(L, 1);
			UIWidget arg0 = LuaScriptMgr.GetUnityObject<UIWidget>(L, 2);
	...
	static int ConstrainTargetToBounds(IntPtr L)
	{
		...
		else if (count == 4)
		{
			UIPanel obj = LuaScriptMgr.GetUnityObject<UIPanel>(L, 1);
			Transform arg0 = LuaScriptMgr.GetUnityObject<Transform>(L, 2);
			Bounds arg1 = LuaScriptMgr.GetNetObject<Bounds>(L, 3);
