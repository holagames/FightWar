...
public class CubemapWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.Cubemap", typeof(Cubemap), regs, fields, typeof(UnityEngine.Texture));
	}
	...
	static int SetPixel(IntPtr L)
	{
		...
		Cubemap obj = LuaScriptMgr.GetUnityObject<Cubemap>(L, 1);
