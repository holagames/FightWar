...
public class Texture2DWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.Texture2D", typeof(Texture2D), regs, fields, typeof(UnityEngine.Texture));
	}
	...
	static int UpdateExternalTexture(IntPtr L)
	{
		...
		Texture2D obj = LuaScriptMgr.GetUnityObject<Texture2D>(L, 1);
