...
public class AnimatorWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.Animator", typeof(Animator), regs, fields, typeof(UnityEngine.Behaviour));
	}
	...
	static int set_avatar(IntPtr L)
	{
		...
		obj.avatar = LuaScriptMgr.GetUnityObject<Avatar>(L, 3);
		return 0;
	}
	...
	static int GetFloat(IntPtr L)
	{
		...
		{
			Animator obj = LuaScriptMgr.GetUnityObject<Animator>(L, 1);
