...
public class LightmapDataWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.LightmapData", typeof(LightmapData), regs, fields, typeof(System.Object));
	}
	...
	static int set_lightmapFar(IntPtr L)
	{
		...
		obj.lightmapFar = LuaScriptMgr.GetUnityObject<Texture2D>(L, 3);
		return 0;
	}
	...
	static int set_lightmapNear(IntPtr L)
	{
		...
		obj.lightmapNear = LuaScriptMgr.GetUnityObject<Texture2D>(L, 3);
		return 0;
	}
}
