...
public class ComputeShaderWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.ComputeShader", typeof(ComputeShader), regs, fields, typeof(UnityEngine.Object));
	}
	...
	static int FindKernel(IntPtr L)
	{
		...
		ComputeShader obj = LuaScriptMgr.GetUnityObject<ComputeShader>(L, 1);
	...
	static int SetTexture(IntPtr L)
	{
		...
		Texture arg2 = LuaScriptMgr.GetUnityObject<Texture>(L, 4);
