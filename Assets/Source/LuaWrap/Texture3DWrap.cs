...
public class Texture3DWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.Texture3D", typeof(Texture3D), regs, fields, typeof(UnityEngine.Texture));
	}
	...
	static int GetPixels(IntPtr L)
	{
		...
		if (count == 1)
		{
			Texture3D obj = LuaScriptMgr.GetUnityObject<Texture3D>(L, 1);
