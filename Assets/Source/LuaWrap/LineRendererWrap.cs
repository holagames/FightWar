...
public class LineRendererWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.LineRenderer", typeof(LineRenderer), regs, fields, typeof(UnityEngine.Renderer));
	}
	...
	static int SetWidth(IntPtr L)
	{
		...
		LineRenderer obj = LuaScriptMgr.GetUnityObject<LineRenderer>(L, 1);
