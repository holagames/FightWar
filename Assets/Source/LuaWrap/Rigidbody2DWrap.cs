...
public class Rigidbody2DWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.Rigidbody2D", typeof(Rigidbody2D), regs, fields, typeof(UnityEngine.Component));
	}
	...
	static int MovePosition(IntPtr L)
	{
		...
		Rigidbody2D obj = LuaScriptMgr.GetUnityObject<Rigidbody2D>(L, 1);
