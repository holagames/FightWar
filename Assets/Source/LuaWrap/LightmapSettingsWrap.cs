...
public class LightmapSettingsWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.LightmapSettings", typeof(LightmapSettings), regs, fields, typeof(UnityEngine.Object));
	}
	...
	{
		LuaScriptMgr.Push(L, LightmapSettings.bakedColorSpace);
		return 1;
	}
	...
	{
		LightmapSettings.lightProbes = LuaScriptMgr.GetUnityObject<LightProbes>(L, 3);
		return 0;
	}
