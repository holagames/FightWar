...
public class UILabelWrap
{
	...
	{
		LuaScriptMgr.Push(L, typeof(UILabel));
		return 1;
	}
	...
	static int set_keepCrispWhenShrunk(IntPtr L)
	{
		...
		obj.keepCrispWhenShrunk = LuaScriptMgr.GetNetObject<UILabel.Crispness>(L, 3);
		return 0;
	}
	...
	static int set_bitmapFont(IntPtr L)
	{
		...
		obj.bitmapFont = LuaScriptMgr.GetUnityObject<UIFont>(L, 3);
		return 0;
	}
	...
	static int set_trueTypeFont(IntPtr L)
	{
		...
		obj.trueTypeFont = LuaScriptMgr.GetUnityObject<Font>(L, 3);
		return 0;
	}
	...
	static int set_ambigiousFont(IntPtr L)
	{
		...
		obj.ambigiousFont = LuaScriptMgr.GetUnityObject<Object>(L, 3);
		return 0;
	}
	...
	static int set_alignment(IntPtr L)
	{
		...
		obj.alignment = LuaScriptMgr.GetNetObject<NGUIText.Alignment>(L, 3);
		return 0;
	}
	...
	static int set_symbolStyle(IntPtr L)
	{
		...
		obj.symbolStyle = LuaScriptMgr.GetNetObject<NGUIText.SymbolStyle>(L, 3);
		return 0;
	}
	...
	static int set_overflowMethod(IntPtr L)
	{
		...
		obj.overflowMethod = LuaScriptMgr.GetNetObject<UILabel.Overflow>(L, 3);
		return 0;
	}
	...
	static int set_effectStyle(IntPtr L)
	{
		...
		obj.effectStyle = LuaScriptMgr.GetNetObject<UILabel.Effect>(L, 3);
		return 0;
	}
	...
	static int GetSides(IntPtr L)
	{
		...
		UILabel obj = LuaScriptMgr.GetUnityObject<UILabel>(L, 1);
	...
	static int GetCharacterIndex(IntPtr L)
	{
		...
		UILabel obj = LuaScriptMgr.GetUnityObject<UILabel>(L, 1);
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		KeyCode arg1 = LuaScriptMgr.GetNetObject<KeyCode>(L, 3);
	...
	static int PrintOverlay(IntPtr L)
	{
		...
		UIGeometry arg2 = LuaScriptMgr.GetNetObject<UIGeometry>(L, 4);
		UIGeometry arg3 = LuaScriptMgr.GetNetObject<UIGeometry>(L, 5);
