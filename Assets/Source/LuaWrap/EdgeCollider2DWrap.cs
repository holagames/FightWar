...
public class EdgeCollider2DWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.EdgeCollider2D", typeof(EdgeCollider2D), regs, fields, typeof(UnityEngine.Collider2D));
	}
	...
	static int Reset(IntPtr L)
	{
		...
		EdgeCollider2D obj = LuaScriptMgr.GetUnityObject<EdgeCollider2D>(L, 1);
		obj.Reset();
		return 0;
	}
