...
public class Physics2DWrap
{
	...
	static LuaField[] fields = new LuaField[]
	{
		...
		new LuaField("raycastsStartInColliders", get_raycastsStartInColliders, set_raycastsStartInColliders),
		new LuaField("changeStopsCallbacks", get_changeStopsCallbacks, set_changeStopsCallbacks),
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.Physics2D", typeof(Physics2D), regs, fields, typeof(System.Object));
	}
	...
	{
		LuaScriptMgr.Push(L, Physics2D.gravity);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_raycastsStartInColliders(IntPtr L)
	{
		LuaScriptMgr.Push(L, Physics2D.raycastsStartInColliders);
		return 1;
	}
	...
	{
		LuaScriptMgr.Push(L, Physics2D.changeStopsCallbacks);
		return 1;
	}
	...
	{
		LuaScriptMgr.Push(L, Physics2D.minPenetrationForPenalty);
		return 1;
	}
	...
	{
		Physics2D.gravity = LuaScriptMgr.GetVector2(L, 3);
		return 0;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_raycastsStartInColliders(IntPtr L)
	{
		Physics2D.raycastsStartInColliders = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
	...
	{
		Physics2D.changeStopsCallbacks = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
	...
	{
		Physics2D.minPenetrationForPenalty = (float)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}
	...
	static int IgnoreCollision(IntPtr L)
	{
		...
		if (count == 2)
		{
			Collider2D arg0 = LuaScriptMgr.GetUnityObject<Collider2D>(L, 1);
			Collider2D arg1 = LuaScriptMgr.GetUnityObject<Collider2D>(L, 2);
