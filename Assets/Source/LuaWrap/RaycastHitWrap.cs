...
public class RaycastHitWrap
{
	...
	static int get_barycentricCoordinate(IntPtr L)
	{
		...
		RaycastHit obj = (RaycastHit)o;
		LuaScriptMgr.Push(L, obj.barycentricCoordinate);
		return 1;
	}
	...
	static int get_textureCoord(IntPtr L)
	{
		...
		RaycastHit obj = (RaycastHit)o;
		LuaScriptMgr.Push(L, obj.textureCoord);
		return 1;
	}
	...
	static int get_textureCoord2(IntPtr L)
	{
		...
		RaycastHit obj = (RaycastHit)o;
		LuaScriptMgr.Push(L, obj.textureCoord2);
		return 1;
	}
	...
	static int get_lightmapCoord(IntPtr L)
	{
		...
		RaycastHit obj = (RaycastHit)o;
		LuaScriptMgr.Push(L, obj.lightmapCoord);
		return 1;
	}
	...
	static int set_point(IntPtr L)
	{
		...
		RaycastHit obj = (RaycastHit)o;
		obj.point = LuaScriptMgr.GetVector3(L, 3);
	...
	static int set_barycentricCoordinate(IntPtr L)
	{
		...
		RaycastHit obj = (RaycastHit)o;
		obj.barycentricCoordinate = LuaScriptMgr.GetVector3(L, 3);
		LuaScriptMgr.SetValueObject(L, 1, obj);
		return 0;
	}
