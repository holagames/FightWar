...
public class ParticleSystemWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.ParticleSystem", typeof(ParticleSystem), regs, fields, typeof(UnityEngine.Component));
	}
	...
	static int Emit(IntPtr L)
	{
		...
		if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(ParticleSystem), typeof(UnityEngine.ParticleSystem.Particle)))
		{
			ParticleSystem obj = LuaScriptMgr.GetUnityObject<ParticleSystem>(L, 1);
