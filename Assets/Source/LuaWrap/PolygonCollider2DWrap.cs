...
public class PolygonCollider2DWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.PolygonCollider2D", typeof(PolygonCollider2D), regs, fields, typeof(UnityEngine.Collider2D));
	}
	...
	static int GetPath(IntPtr L)
	{
		...
		PolygonCollider2D obj = LuaScriptMgr.GetUnityObject<PolygonCollider2D>(L, 1);
