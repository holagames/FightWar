...
public class WWWWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.WWW", typeof(WWW), regs, fields, typeof(System.Object));
	}
	...
	static int GetAudioClipCompressed(IntPtr L)
	{
		...
		else if (count == 3)
		{
			WWW obj = LuaScriptMgr.GetNetObject<WWW>(L, 1);
			bool arg0 = LuaScriptMgr.GetBoolean(L, 2);
			AudioType arg1 = LuaScriptMgr.GetNetObject<AudioType>(L, 3);
	...
	static int LoadImageIntoTexture(IntPtr L)
	{
		...
		WWW obj = LuaScriptMgr.GetNetObject<WWW>(L, 1);
		Texture2D arg0 = LuaScriptMgr.GetUnityObject<Texture2D>(L, 2);
