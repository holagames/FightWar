...
public class Matrix4x4Wrap
{
	...
	static int Equals(IntPtr L)
	{
		...
		Matrix4x4 obj = (Matrix4x4)LuaScriptMgr.GetVarObject(L, 1);
	...
	static int Lua_Mul(IntPtr L)
	{
		...
		if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(Matrix4x4), typeof(LuaTable)))
		{
			Matrix4x4 arg0 = LuaScriptMgr.GetNetObject<Matrix4x4>(L, 1);
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(Matrix4x4), typeof(Matrix4x4)))
		{
			Matrix4x4 arg0 = LuaScriptMgr.GetNetObject<Matrix4x4>(L, 1);
	...
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		Matrix4x4 arg0 = (Matrix4x4)LuaScriptMgr.GetVarObject(L, 1);
		Matrix4x4 arg1 = (Matrix4x4)LuaScriptMgr.GetVarObject(L, 2);
		bool o = arg0 == arg1;
		LuaScriptMgr.Push(L, o);
		return 1;
	}
