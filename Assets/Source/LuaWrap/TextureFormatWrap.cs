...
public class TextureFormatWrap
{
	static LuaMethod[] enums = new LuaMethod[]
	{
		...
		new LuaMethod("ATF_RGB_DXT1", GetATF_RGB_DXT1),
		new LuaMethod("ATF_RGBA_JPG", GetATF_RGBA_JPG),
		new LuaMethod("ATF_RGB_JPG", GetATF_RGB_JPG),
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.TextureFormat", typeof(TextureFormat), enums);
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetATF_RGB_DXT1(IntPtr L)
	{
		LuaScriptMgr.Push(L, TextureFormat.ATF_RGB_DXT1);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetATF_RGBA_JPG(IntPtr L)
	{
		LuaScriptMgr.Push(L, TextureFormat.ATF_RGBA_JPG);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetATF_RGB_JPG(IntPtr L)
	{
		LuaScriptMgr.Push(L, TextureFormat.ATF_RGB_JPG);
		return 1;
	}
