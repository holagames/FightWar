...
public class SystemLanguageWrap
{
	static LuaMethod[] enums = new LuaMethod[]
	{
		...
		new LuaMethod("Hugarian", GetHugarian),
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.SystemLanguage", typeof(SystemLanguage), enums);
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetHugarian(IntPtr L)
	{
		LuaScriptMgr.Push(L, SystemLanguage.Hugarian);
		return 1;
	}
