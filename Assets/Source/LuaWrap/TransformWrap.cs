...
public class TransformWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.Transform", typeof(Transform), regs, fields, typeof(UnityEngine.Component));
	}
	...
	static int set_parent(IntPtr L)
	{
		...
		obj.parent = LuaScriptMgr.GetUnityObject<Transform>(L, 3);
		return 0;
	}
