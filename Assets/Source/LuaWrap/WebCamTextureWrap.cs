...
public class WebCamTextureWrap
{
	...
	{
		LuaScriptMgr.RegisterLib(L, "UnityEngine.WebCamTexture", typeof(WebCamTexture), regs, fields, typeof(UnityEngine.Texture));
	}
	...
	static int Play(IntPtr L)
	{
		...
		WebCamTexture obj = LuaScriptMgr.GetUnityObject<WebCamTexture>(L, 1);
		obj.Play();
		return 0;
	}
