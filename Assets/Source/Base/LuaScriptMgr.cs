...
public class LuaScriptMgr
{
    ...
    public void Update()
    {
        ...
        {
            updateFunc.Call();
            Debugger.LogError("{0}", updateFunc);
        }
    ...
    public byte[] Loader(string name)
    {
        ...
        try
        {
            ...
            //////////////////////////////////直接读////////////////////////////////            
            if (Resources.Load("Lua/CoreLua/" + name) != null)
            {
                TextAsset TextScript = Resources.Load("Lua/CoreLua/" + name) as TextAsset;
                str = TextScript.bytes;
            }
            else
            {
                Debugger.LogError("Lua/CoreLua/" + name);
            }
            //////////////////////////////////直接读////////////////////////////////
