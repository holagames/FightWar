...
namespace Unibill.Impl {
    public class BillerFactory {
        ...
        public DownloadManager instantiateDownloadManager(Biller biller) {
            var result = new DownloadManager (util, storage, new UnityURLFetcher (),
                logger, biller.InventoryDatabase.CurrentPlatform, biller.InventoryDatabase.UnibillAnalyticsAppSecret,
                biller.InventoryDatabase.UnibillAnalyticsAppId);
